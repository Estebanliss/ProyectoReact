const products = [
  {
    ...
    image: ["https://i.annihil.us/u/prod/marvel/i/mg/2/90/62432e610ac07/clean.jpg"],
    sales: 10.0,
    categoryId: "comic",
    Rating: "Rated T",
  },
  {
    ...
    image: ["https://i.annihil.us/u/prod/marvel/i/mg/f/03/62432e8e49266/clean.jpg"],
    sales: 6.3,
    categoryId: "comic",
  ...
  },
  {
    ...
    image: ["https://i.annihil.us/u/prod/marvel/i/mg/9/00/62432ea15bdc9/clean.jpg"],
    sales: 3.122,
    categoryId: "comic",
    Rating: "Rated T",
  },
  {
    ...
    image: ["https://i.annihil.us/u/prod/marvel/i/mg/9/10/62432e9acd0a8/clean.jpg"],
    sales: 1.122,
    categoryId: "comic",
    Rating: "Rated T+",
  },
  {
    ...
    image: ["https://i.annihil.us/u/prod/marvel/i/mg/3/f0/62432e4f2879d/clean.jpg"],
    sales: 1.122,
    categoryId: "comic",
    Rating: "Rated T+",
  },
  {
    ...
    cost: 10.99,
    description:
      "Deep dive into the gameplay experience of ‘Marvel’s Midnight Suns’ - an epic tactical RPG set in the darker side of the Marvel Universe.",
    image: ["https://terrigen-cdn-dev.marvel.com/content/prod/1x/midnightsons_lob_crd_02.jpg"],
    sales: 1.122,
    categoryId: "game",
    Rating: "Rated T+",
  },
  {
    ...
    cost: 10.99,
    description:
      "Oh, flark! There’s even more music from Marvel’s Guardians of the Galaxy?! Turn the volume to eleven and get your galactic grove on with Marvel’s Guardians of the Galaxy: Welcome to Knowhere EP Original Video Game Soundtrack, available to stream.",
    image: [
  ...
  },
  {
    ...
    cost: 10.99,
    description:
      "A new future begins! We're giving you an exclusive look at the upcoming MARVEL Future Revolution, our first open world action RPG on mobile, now! Pre-register here: https://netmarble.sng.link/D80n1/5teu ",
    image: ["https://terrigen-cdn-dev.marvel.com/content/prod/1x/futurerevolution_lob_crd_01.jpg"],
    sales: 1.122,
    categoryId: "game",
    Rating: "Rated T+",
  },
  {
    ...
    image: ["https://terrigen-cdn-dev.marvel.com/content/prod/1x/marvelsavengers_lob_crd_01_0.jpg"],
    sales: 1.122,
    categoryId: "game",
    Rating: "Rated T+",
  },
  {
    ...
    image: ["https://terrigen-cdn-dev.marvel.com/content/prod/1x/msmmm_lob_crd_02_0.jpg"],
    sales: 1.122,
    categoryId: "game",
    Rating: "Rated T+",
  },
  ...
  },
  {
    ...
    cost: 10.99,
    description:
      "Doctor Strange in the Multiverse of Madness —a thrilling ride through the Multiverse with Doctor Strange, his trusted friend Wong and Wanda Maximoff, aka Scarlet Witch. Doctor Strange in the Multiverse of Madness opens in U.S. theaters on May 6, 2022.",
    image: [
  ...
  },
  {
    ...
    image: ["https://terrigen-cdn-dev.marvel.com/content/prod/1x/eternals_lob_crd_06.jpg"],
    sales: 1.122,
    categoryId: "movie",
    Rating: "Rated T+",
  },
  {
    ...
    image: ["https://terrigen-cdn-dev.marvel.com/content/prod/1x/shangchi_lob_crd_07.jpg"],
    sales: 1.122,
    categoryId: "movie",
    Rating: "Rated T+",
  },
